...
#+BEGIN_SRC clojure :noweb-ref test
  (deftest conversion-rgb
    ...
    (is (d= [0.3333333 1 1 1] @(col/as-hsva (col/rgba 0 1 0 1))))
    (is (d= [0.6666666 1 1 1] @(col/as-hsva (col/rgba 0 0 1 1))))
    ...
    (is (d= [0.3333333 1 0.5 1] @(col/as-hsla (col/rgba 0 1 0 1))))
    (is (d= [0.6666666 1 0.5 1] @(col/as-hsla (col/rgba 0 0 1 1))))
...
#+BEGIN_SRC clojure :noweb-ref test
  (deftest conversion-hsv
   ...
   (is (d= [0 1 0 1] @(col/as-rgba (col/hsva 0.3333333 1 1))))
   (is (d= [0 0.5 0.5 1] @(col/as-rgba (col/hsva 0.5 1 0.5))))
   (is (d= [0 0 1 1] @(col/as-rgba (col/hsva 0.6666666 1 1 1))))
   (is (d= [1 1 1 1] @(col/as-rgba (col/hsva 0.6666666 0 1 1))))
   (is (d= 0xff0000 @(col/as-int24 (col/hsva 0 1 1))))
   (is (d= 0x00ff00 @(col/as-int24 (col/hsva 0.3333333 1 1))))
   (is (d= 0x0000ff @(col/as-int24 (col/hsva 0.6666666 1 1))))
   (is (d= 0x3fff0000 @(col/as-int32 (col/hsva 0 1 1 0.25))))
   (is (d= 0x7f00ff00 @(col/as-int32 (col/hsva 0.3333333 1 1 0.5))))
   (is (d= 0xff0000ff @(col/as-int32 (col/hsva 0.6666666 1 1))))
   ...
   (is (d= [0.3333 1 0.75 1] @(col/as-hsla (col/hsva 0.3333333 0.5 1))))
   ...
   (is (= "hsl(120,100%,75%)" @(col/as-css (col/hsva 0.3333333 0.5 1))))
   (is (= "hsla(240,100%,25%,0.25)" @(col/as-css (col/hsva 0.6666666 1 0.5 0.25)))))
#+END_SRC
...
#+BEGIN_SRC clojure :noweb-ref test
  (deftest conversion-hsl
   ...
   (is (d= [0 1 0 1] @(col/as-rgba (col/hsla 0.3333333 1 0.5))))
   (is (d= [0 1 1 1] @(col/as-rgba (col/hsla 0.5 1 0.5))))
   (is (d= [0 0 1 1] @(col/as-rgba (col/hsla 0.6666666 1 0.5 1))))
   (is (d= [0.5 0.5 0.5 1] @(col/as-rgba (col/hsla 0.6666666 0 0.5 1))))
   (is (d= 0xff0000 @(col/as-int24 (col/hsla 0 1 0.5))))
   (is (d= 0x00ff00 @(col/as-int24 (col/hsla 0.3333333 1 0.5))))
   (is (d= 0x0000ff @(col/as-int24 (col/hsla 0.6666666 1 0.5))))
   (is (d= 0x3fff0000 @(col/as-int32 (col/hsla 0 1 0.5 0.25))))
   (is (d= 0x7f00ff00 @(col/as-int32 (col/hsla 0.3333333 1 0.5 0.5))))
   (is (d= 0xff0000ff @(col/as-int32 (col/hsla 0.6666666 1 0.5))))
   ...
   (is (d= [0.3333 0.66666 0.75 1] @(col/as-hsva (col/hsla 0.3333333 0.5 0.5))))
   ...
   (is (= "hsl(120,50%,100%)" @(col/as-css (col/hsla 0.3333333 0.5 1))))
   (is (= "hsla(240,100%,50%,0.25)" @(col/as-css (col/hsla 0.6666666 1 0.5 0.25)))))
#+END_SRC
