...
#+BEGIN_SRC clojure :noweb-ref test
  (deftest conversion-hsv
   ...
   (is (d= 0x8000ff00 @(col/as-int32 (col/hsva col/THIRD 1 1 0.5))))
...
#+BEGIN_SRC clojure :noweb-ref test
  (deftest conversion-hsl
   ...
   (is (d= 0x8000ff00 @(col/as-int32 (col/hsla col/THIRD 1 0.5 0.5))))
...
#+BEGIN_SRC clojure :noweb-ref test
  (deftest blending
    (let [c1  (col/rgba 1 0 0 0)
      ...
      (is (= 0x4000bf @(col/blend c9 c11 0.75)))
      ...
      (is (= 0x407f007f @(col/blend c12 c6 0.5)))
      (is (= 0x40ff7f7f @(col/blend c12 c8 0.5)))
   ))
#+END_SRC
