  ...
  #?(:clj
     (deftest test-buffers
       (let [c (col/rgba 1 0 0 0.5)]
         (is (d= [1 0 0 0.5] (buf-seq c)))
         (is (d= [1 0 0 1] (buf-seq (col/int24 0xff0000))))
         (is (d= [1 0 0 0.5] (buf-seq (col/int32 0x80ff0000))))
         (is (d= [0 1 1 0.5] (buf-seq (col/as-hsva c))))
         (is (d= [0 1 0.5 0.5] (buf-seq (col/as-hsla c))))
         (is (d= [1 0 0 0.5] (buf-seq (col/as-cmyka c))))
         (is (d= [1 0 0 0.5] (buf-seq (col/as-css c)))))))
#+END_SRC
