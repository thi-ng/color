...
#+BEGIN_SRC clojure :noweb-ref test
  (deftest conversion-rgb
    ...
    (is (= 0x8000ff00 @(col/as-int32 (col/rgba 0 1 0 0.5))))
...
#+BEGIN_SRC clojure :noweb-ref test
  (deftest conversion-hsv
   ...
   (is (d= 0x8000ff00 @(col/as-int32 (col/hsva m/THIRD 1 1 0.5))))
   (is (d= 0xff0000ff @(col/as-int32 (col/hsva m/TWO_THIRD 1 1))))
...
#+BEGIN_SRC clojure :noweb-ref test
  (deftest conversion-hsl
   ...
   (is (d= 0x8000ff00 @(col/as-int32 (col/hsla m/THIRD 1 0.5 0.5))))
   (is (d= 0xff0000ff @(col/as-int32 (col/hsla m/TWO_THIRD 1 0.5))))
...
#+BEGIN_SRC clojure :noweb-ref test
  (deftest css-parse
    ...
    (is (d= 0xff00ffff @(col/as-int32 (col/css "hsl(180,100%,50%)"))))
...
#+BEGIN_SRC clojure :noweb-ref test
  (deftest blending
    (let [c1  (col/rgba 1 0 0 0)
      ...
      (is (= 0x7f7f00 @(m/mix c9 c10 0.5)))
      (is (= 0x4000bf @(m/mix c9 c11 0.75)))
      (is (= 0x7f007f @(m/mix c9 c3 0.5)))
      (is (= 0x7f007f @(m/mix c9 c6 0.5)))
      (is (= 0x7f7f00 @(m/mix c9 c7 0.5)))
      (is (= 0xff7f7f @(m/mix c9 c8 0.5)))
      ;; int32
      (is (= 0xbf7f007f @(m/mix c14 c9 0.5)))
      (is (= 0xbf007f7f @(m/mix c14 c13 0.5)))
      (is (= 0xbf007f7f @(m/mix c14 c13 0.5)))
      (is (= 0x7f7f7f00 @(m/mix c12 c2 0.5)))
      (is (= 0x407f007f @(m/mix c12 c6 0.5)))
      (is (= 0x40ff7f7f @(m/mix c12 c8 0.5)))
   ))
#+END_SRC
