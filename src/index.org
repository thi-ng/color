...
The library supports the following color spaces: RGB, HSV, HSL, HCY,
HCV, CMYK, CIE1931. In addition conversion to/from CSS colors is
supported.
...
gradients and features 100+ CSS named color presets as well as D3's &
Cynthia Brewer's categorical color schemes originally intented for geo
mapping and other data visualization applications.
...
- [[./gradients.org][thi.ng.color.gradients]]
